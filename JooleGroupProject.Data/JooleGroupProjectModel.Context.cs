...
namespace JooleGroupProject.Data
{
    ...
    public partial class JooleAppDBEntities1 : DbContext
    {
        public JooleAppDBEntities1()
            : base("name=JooleAppDBEntities1")
        {
        }
        ...
        public virtual DbSet<tblSpecFilter> tblSpecFilters { get; set; }
